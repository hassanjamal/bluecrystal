...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="{{{ URL::to('/')}}}" class="navbar-brand"><strong><span style="color:blue">BLUE </span>CRYSTAL
                    QUASI BANK</strong></a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" role="navigation">
            <ul class="nav navbar-nav pull-right">
                ...
                <li><a href="{{{ URL::to('/') }}}">Logged in as {{{ Sentry::getUser()->first_name .'
                        '.Sentry::getUser()->last_name}}}</a></li>
