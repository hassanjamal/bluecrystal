    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="tab-general">
            ...
            <div class="form-group {{{ $errors->has('special_interest') ? 'error' : '' }}}">
                ...
                <div class="col-md-3">
                    <input class="form-control" type="text" name="special_interest" id="special_interest" value="{{{ Input::old('special_interest', isset($fdscheme) ? $fdscheme->special_interest : null) }}}" />
                    {{{ $errors->first('interest', '<span class="help-inline">:message</span>') }}}
                </div>
            </div>
        </div>
