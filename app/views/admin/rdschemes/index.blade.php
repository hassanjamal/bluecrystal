	...
	<div class="page-header">
		<h3>
			...
			<div class="pull-right">
				<a href="{{{ URL::to('admin/rd-schemes/create') }}}" class="btn btn-small btn-info iframe"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
			</div>
			@endif
		</h3>
	</div>
...
@section('scripts')
	<script type="text/javascript">
		...
		$(document).ready(function() {
				...
				"bProcessing": true,
		        "bServerSide": true,
		        "sAjaxSource": "{{ URL::to('admin/rd-schemes/data') }}",
