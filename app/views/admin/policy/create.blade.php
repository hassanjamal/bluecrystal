                ...
                <div class="row well" id="official_details">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="associate_no" id="associate_no" value="{{{ Input::old('associate_no', isset($policy) ? $policy->associate_no : null) }}}"/>
                            </div>
                        </div>
                    </div>
                    <!-- ./ associate_no -->
                        ...
                        <div class="well form-group">
                            ...
                            <div class="col-md-6" id="fd_scheme_amount_block">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-8">
                                        <input class="form-control" type="text" name="fd_scheme_amount" id="fd_scheme_amount" value="{{{ Input::old('fd_scheme_amount', isset($policy) ? $policy->fd_scheme_amount : null) }}}" data-bv-notempty data-bv-notempty-message="Amount is required"/>
                                    </div>
                                </div>
                            </div>
                            <!-- ./scheme amount -->
                            ...
                            <div class="col-md-6" id="fd_maturity_amount_block">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-8">
                                        <input readonly class="form-control" type="text" name="fd_maturity_amount" id="fd_maturity_amount" value=""/>
                                    </div>
                                </div>
                            </div>
                            <!-- ./Maturity amount -->
                ...
                <div class="row well" id="payment_block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {{ Form::select('payment_mode',array( 'cash' => 'Cash', 'cheque' => 'Cheque', 'dd' => 'DD',) ,isset($policy) ? $policy->payment_mode : 'cash', array('class'=>'form-control ', 'id' => 'payment_mode'))}}
                            </div>
                        </div>
                    </div>
                    <!-- ./ payment_mode -->
                ...
                <div class="row well">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {{ Form::select('guardian_type',array( 'father' => 'Father', 'husband' => 'Husband', 'other' => 'Others') ,isset($policy) ? $policy->guardian_type : null, array('class'=>'form-control '))}}
                            </div>
                        </div>
                    </div>
                    <!-- Guardian end -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{{ $errors->has('sex') ? 'error' : '' }}}">
                            ...
                            <div class="col-md-8">
                                {{ Form::select('sex',array( 'Male' => 'Male', 'female' => 'Female') ,isset($policy) ? $policy->sex : null, array('class'=>'form-control '))}}
                            </div>
                        </div>
                    </div>
                    <!-- ./ Sex -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{{ $errors->has('date_of_birth') ? 'error' : '' }}}">
                            ...
                            <div class="col-md-8">
                                <div class="input-appended">
                                    <input class="date-picker form-control" type="text" name="date_of_birth" id="date_of_birth" value="{{{ Input::old('date_of_birth', isset($policy) ? $policy->date_of_birth : date("Y-m-d") ) }}}"/>
                ...
                <div class="row well">
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="nominee_relation" id="nominee_relation" value="{{{ Input::old('nominee_relation', isset($policy) ? $policy->nominee_relation : null) }}}"/>
                            </div>
                        </div>
                    </div>
                    <!-- ./ nominee_relation -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="col-md-8">
                                {{ Form::selectRange('nominee_age', 10, 70,isset($policy) ? $policy->nominee_age : 35, array('class'=>'form-control '))}}
                            </div>
                        </div>
                    </div>
                    <!-- ./ nominee_age -->
