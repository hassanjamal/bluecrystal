            ...
            <div class="panel-body">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <div class="row">
                                <div class="col-md-6 "><span class="pull-left">Dear Mr/Mrs. <strong>{{$associate->name}}</strong> </span></div>
                                <div class="col-md-6 "><span class="pull-right">ID : <strong>{{$associate->associate_no}}</strong> </span></div>
                            </div>
                            <br>
                            <br>
                            <div class="row">
                                <div class="col-md-12">
                                    <p>
                                        Congratulations!! <br>
                                        For having decided to be an <strong>BLUE CRYSTAL MUTUAL BENEFIT INDIA LIMITED</strong> independent member. Your designation is <strong>{{$rank_name}}</strong>.
                                    </p>
                                    <br>
                                    <p>
